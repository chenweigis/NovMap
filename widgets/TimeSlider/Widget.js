...
define(['dojo/_base/declare',
  ...
  function(declare, lang, html, array, dojoConfig, baseFx,
    ...
    LayerInfos, BaseWidget, esriLang, esriRequest, TimeExtent, TimeSlider,Extent,SpatialReference) {
    // box of speed-menu
    var menuBox = {
      w: 105,
      h: 123
    ...
    var clazz = declare([BaseWidget], {
      ...
      setMapVisible :function(){
        var ldLayer=this.map._layers.didi_2006;
        ldLayer.setVisibility(true);
       /* var extent=new Extent(ldLayer.initialExtent.xmin, ldLayer.initialExtent.ymin,
        ldLayer.initialExtent.xmax,ldLayer.initialExtent.ymax
        ,new SpatialReference(ldLayer.initialExtent.spatialReference.wkt));
        //ldLayer.initialExtent.spatialReference={"wkid":102100}
      ...
      onClose: function() {
        ...
        this.map._layers.didi_2006.setVisibility(false);
      },
