    ...
    var clazz = declare([BaseWidget], {
      ...
      startup: function() {
		...
		onOpen: function() {
			...
			this.map._layers.Basemap_blue_3666.vsible=true;
			this.num++
			this.inherited(arguments);
			if(this.num==1)
				return
			...
			this.map._layers.Basemap_blue_3666.setVisibility(true);
		},
	onClose: function() {
		...
		this.map._layers.Basemap_blue_3666.setVisibility(false);
