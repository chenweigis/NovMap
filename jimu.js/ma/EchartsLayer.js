define([
  "dojo/_base/declare",
  "dojo/_base/lang", "esri/geometry/Point", "esri/geometry/ScreenPoint", 'dojo/topic'
], function(declare, lang, Point, ScreenPoint,topic) {
  return declare("EchartsLayer", null, {
    ...
    _init: function(map, ec) {
      ...
      self.initECharts = function() {
        ...
        self._bindEvent();
        self._addMarkWrap();
        topic.subscribe("unbind",self._unbindEvent);
        return self._ec;
        /*
         * 发布关闭微件方法
         * */
   ...
   /*   self._bindEvent = function() {
      ...
      self.creatEchart=function(){
        topic.subscribe("setOption",self.setOption(self._option));
      }
    }
